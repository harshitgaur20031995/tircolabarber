...
public class PinoCal extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pino_cal);
        getSupportActionBar().hide();


        context = PinoCal.this;
    ...
    public void goScelta1(View view) {
        startActivity(new Intent(getApplicationContext(), Barbieri.class));
        finish();
    }

    private void setAdapter() {
        adapter = new Adapter(PinoCal.this, orari, strings, dateA, month.toLowerCase(), barber, new Adapter.onItemClick() {
            @Override
    ...
    private void checkWaiting(EmanBook emanBook) {
        ...
        FirebaseFirestore firestore = FirebaseFirestore.getInstance();
        CollectionReference reference = firestore.collection("pinobooking");
    ...
    private void Booking(EmanBook emanBook) {
        ...
        FirebaseFirestore firestore = FirebaseFirestore.getInstance();
        firestore.collection("pinobooking").add(emanBook).addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
            @Override
            public void onSuccess(DocumentReference documentReference) {
                Log.v("logcheck", "on successs" + documentReference.getId());
                Toast.makeText(PinoCal.this, "Slot Time Booked Successfully", Toast.LENGTH_SHORT).show();
